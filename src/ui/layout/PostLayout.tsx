...
import CopySidebar from './navbar/CopySidebar';
...
const PostLayout: React.FC<Props> = ({
  ...
  return (
    <Wrapper {...props}>
      ...
      <CopySidebar collapsed={collapsed} setCollapsed={setCollapsed} author={author} profile={accountProfile} />
...
export default connect(mapStateToProps)(withApollo({ ssr: true })(PostLayout));
